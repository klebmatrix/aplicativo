...
# --- 3. BARRA LATERAL (CONFIGS, LIMPAR E SAIR) ---
...
if st.session_state.perfil == "admin":
    ...
    # Exemplo de Lógica para o Gerador de Operações
    if menu == "op":
        st.header("🔢 Operações")
        n_ini = st.number_input("Começar no nº:", value=6)
        if st.button("Gerar Agora"):
            st.session_state.preview_questoes = [".M1", "t. ATIVIDADE", f"{n_ini}. Resolva:"] + \
